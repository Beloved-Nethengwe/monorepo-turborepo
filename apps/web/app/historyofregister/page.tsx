  ...
  return (
    <div>
      ...
      <main className="ui-flex ui-items-center ui-justify-center ui-min-h-screen ui-bg-gray-100">
        <div className="ui-bg-white ui-shadow-md ui-rounded-lg ui-p-6">
          <h2 className="ui-text-xl ui-font-semibold ui-mb-4 ui-text-center">
            User Registration History - {currentDate}
          </h2>

          <div className="ui-flex ui-justify-between ui-mb-4">
            {Object.keys(groupedData).map((date) => (
              <button
                key={date}
                onClick={() => handleDateChange(date)}
                className={`ui-mx-1 ui-py-1 ui-px-3 ui-rounded ${currentDate === date ? 'ui-bg-lime-800 ui-text-white' : 'ui-bg-gray-300'}`}
              >
                {date}
              </button>
            ))}
          ...
          <div className="ui-flex ui-justify-between ui-mt-4">
            <button
