        ...
        <div>
            ...
            <main className="ui-flex ui-items-center ui-justify-center ui-min-h-screen ui-bg-gray-100">
                <div className="ui-bg-white ui-shadow-md ui-rounded-lg ui-p-6">
                    <h2 className="ui-text-xl ui-font-bold ui-mb-4 ui-text-center">Today's Register- {new Date().toLocaleDateString()}</h2>
                            ...
                            <tbody>
                                {displayedUsers.map((user, index) => (
                                    <tr key={index} className="ui-bg-gray-400">
                                        ...
                                        <td className="ui-border ui-py-2 ui-px-4">{user?.currentDate.toString().split('T')[0]}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
